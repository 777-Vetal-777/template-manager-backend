...
public class ResourceImportServiceImpl implements ResourceImportService {
    ...
    public ResourceUriGenerator getResourceUriGenerator(final String fileName) {
        ...
        return () -> "dito-asset://".concat(resourceLeafDescriptorMapper.encodeId(new StringBuilder(namePattern).append("(").append(resourceId.incrementAndGet()).append(")").toString(), ResourceTypeEnum.IMAGE, null));
    }
